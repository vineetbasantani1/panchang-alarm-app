...
public enum TithiCalculator {

    // MARK: - Public API

    /// Returns (tithiNumber 1...30, tithiName) prevailing at sunrise on the
    /// given calendar date, for the given latitude/longitude.
    public static func tithi(onDate date: Date, latitude: Double, longitude: Double) -> (number: Int, name: String) {
    ...
    public static func upcomingMatches(
